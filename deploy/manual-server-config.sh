...
DOMAIN_NAME='54.201.54.71'
SUBDOMAIN_NAME="$GH_PRJ"
REMOTE_USER='ubuntu'
BASHRC_PATH="$HOME/.bashrc"
PUBLIC_IP='54.201.54.71'  # from AWS EC2 Dashboard
SRV='/srv'
...
mkdir -p $HOME/.ssh/
envsubst < $HOME/.ssh/config.envsubst >> $HOME/.ssh/config
# your ~/.ssh/config file needs an entry like this
